  ...
  return (
    <div className="spot-details-reviews-container">
      <div className="spot-details-reviews-header-container">
        <div className="spot-details-reviews-rating-count"><i className="fa-solid fa-star"></i> {!spot.numReviews ? `New` : `${parseFloat(spot.avgStarRating).toFixed(1)} • ${spot.numReviews} Reviews`} </div>
